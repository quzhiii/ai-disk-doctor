...
fn readme_english_exists_and_has_required_sections() {
    ...
    assert!(readme.contains("version-1.5.0"), "Should show v1.5.0 badge");
    assert!(readme.contains("**Current release:** v1.5.0"), "Should show v1.5.0 current release");
    assert!(
        readme.contains("### v1.5.0") && readme.contains("docs/release-notes/v1.5.0.md"),
        "Should document v1.5.0 release notes"
    );
...
fn readme_chinese_exists_and_has_required_sections() {
    ...
    assert!(readme.contains("version-1.5.0"), "Should show v1.5.0 badge");
    assert!(readme.contains("**当前版本：** v1.5.0"), "Should show v1.5.0 current release");
    assert!(
        readme.contains("### v1.5.0") && readme.contains("docs/release-notes/v1.5.0.md"),
        "Should document v1.5.0 release notes"
    );
